## This code was taken from hiive-mdptoolbox library
## https://github.com/hiive/hiivemdptoolbox/blob/master/hiive/mdptoolbox/openai.py
## I had issues importing the library via:
##      from hiive.mdptoolbox import openai
## Note: Jaeyong Kim (jkim3018 - 903042675)
